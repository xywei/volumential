...
Curated figures live under `doc/source/_static/gallery/`, but numerical
figures are generated by the maintained examples rather than by Sphinx.
{doc}`gallery-assets` records the regeneration commands and the rule that
documentation builds never launch OpenCL workloads.

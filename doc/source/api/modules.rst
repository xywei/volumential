...
:py:mod:`volumential.meshgen`.

The active implementation is the boxtree-based path (including adaptive
...
can be evaluated directly on volume quadrature targets, enabling boundary to
volume handoff workflows.
